...
This two-tiers application is built upon a diverse set of technologies, each chosen for its specific strengths and contributions:
...
Getting the two-tiers applications from scratch to launch took me 3 days:
